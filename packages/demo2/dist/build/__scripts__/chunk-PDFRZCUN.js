...
// ../daxt/dist/lib/index.js
var require_lib = __commonJS({
  "../daxt/dist/lib/index.js"(exports) {
    "use strict";
    var __rest =
    ...
    var cmp2 = (execHtml) => {
      return function (tag2 = "") {
        return function (props) {
          ...
          let _a = execHtml(
              Object.assign(Object.assign({}, props), { setHead })
            ),
            { html: html3, dependencies } = _a,
            res = __rest(_a, ["html", "dependencies"]);
...
// esbuild-css-modules-plugin-namespace:/tmp/tmp-106452-ZK3GnBbMtDNb/demo2/src/components/x-title/style.module.css.js
...
// src/components/x-title/index.ts
var tag = "x-title";
var Title = (0, import_lib.cmp)(
  ({ title }) => import_lib.html`
  <h1 class="${style_module_css_default.title}">${title}</h1>
`
)(tag);

export { require_lib, tag, Title };
